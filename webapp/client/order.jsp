										...
										<tr>
											<td>
												...
												<p>
												    ...
												    &nbsp;&nbsp;&nbsp;&nbsp;
													<br/> 
													QQ邮箱：<input type="text" id="receiverMail" name="receiverMail" value="${user.email}" style="width:150px" onkeyup="checkReceiverEmail();" />
													<span id="receiverEmailMsg"></span>
													&nbsp;&nbsp;&nbsp;&nbsp;
												</p>
												<hr />
												<p style="text-align:right">
                                                <button onclick="checkOnSubmit();" style="background-color: orange; color: white; font-size: 16px; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer;">
                                                 提交订单
                                                </button>
                                                </p>
											</td>
