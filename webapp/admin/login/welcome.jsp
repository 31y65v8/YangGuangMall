...
<form name="Form1" method="post" id="Form1">
	<table width="80%" border="0" height="88" background="${pageContext.request.contextPath}/admin/images/back1.jpg">
		<tr>
			<td colspan=3 class="ta_01" align="center" bgcolor="#f59f1d"><strong>商城管理系统</strong></td>
		</tr>
		<tr>
			<td width="65%" height="84" align="center" valign="top" >
				<br />
				<span class="size:48;">${user.username} ，欢迎！</span>
			</td>
		</tr>
