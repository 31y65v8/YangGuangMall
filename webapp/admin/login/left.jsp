...
<head>
	...
	<body>
		...
		<table width="100%" border="0">
			  ...
			  <tr>
			  	<td><a href="${pageContext.request.contextPath}/admin/report/report.jsp" target="mainFrame" class="left_list">销售报表</a></td>
			  </tr>
			  
			  <tr>
			  	<td><a href="${pageContext.request.contextPath}/admin/log/browselog.jsp" target="mainFrame" class="left_list">浏览记录</a></td>
			  </tr>
