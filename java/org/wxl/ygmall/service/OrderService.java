...
import org.wxl.ygmall.dao.OrderDao;
import org.wxl.ygmall.dao.OrderItemDao;
...
public class OrderService {
	...
	public void addOrder(Order order) {
		try {
			 // 打印 receiverMail
		    System.out.println("Receiver Mail: " + order.getReceiverMail());
			// 1.开启事务
	...
	// 支付成功后修改订单状态和支付时间
	public void updateStateandPaytime(String id) {
		try {
			DataSourceUtils.startTransaction();
			odao.updateOrderState(id);
	        odao.updatepaytime(id);
